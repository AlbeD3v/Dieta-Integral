        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 relative">
            <h2 className="relative text-4xl md:text-5xl lg:text-6xl font-bold">
              <span className="absolute -top-6 md:-top-8 left-1/2 -translate-x-1/2 text-primary/10 text-5xl md:text-6xl lg:text-7xl whitespace-nowrap">
            ...
            <p className="text-xl text-foreground/80 mt-6">Artículos destacados para mejorar tu salud</p>
          </div>
