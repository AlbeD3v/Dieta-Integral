...
export const article4: ArticleFull = {
  id: 4,
  slug: '4',
  title: '¿Qué es realmente la Dieta Integral? (Y por qué es diferente a todo lo que has probado)',
  summary: 'Pregunta directa: ¿Cuántas veces has empezado una "dieta" este año pensando que esta vez sí iba a funcionar?',
  images: [
    '/articulos/articulo4/articulo4_1.jpg',
    '/articulos/articulo4/articulo4_2.jpg',
    '/articulos/articulo4/articulo4_3.jpg',
    '/articulos/articulo4/articulo4_4.jpg',
    '/articulos/articulo4/articulo4_5.jpg',
    '/articulos/articulo4/articulo4_6.jpg',
    '/articulos/articulo4/articulo4_7.jpg',
    '/articulos/articulo4/articulo4_8.jpg',
    '/articulos/articulo4/articulo4_9.jpg',
    '/articulos/articulo4/articulo4_10.jpg'
  ],
  articleUrl: '/articulos/4',
  publicationDate: '12 de septiembre, 2025',
  content: `# ¿Qué es realmente la Dieta Integral? (Y por qué es diferente a todo lo que has probado)
...
- *Comida real:* Carne, pescado, órganos, grasas animales, sin procesar
- *Ayunos naturales:* Comían cuando había comida, no cada tres horas
- *Grasas como combustible principal:* No azúcar constante  
- *Ritmos circadianos naturales:* Se movían con el sol, descansaban en la oscuridad
- *Movimiento funcional:* Caminatas, carga, sprints ocasionales

*Tu cuerpo sigue esperando exactamente eso.*

Pero la vida moderna te empuja a hacer lo contrario:
- Alimentos ultraprocesados con etiquetas de "saludable"
- Comer cada 2-3 horas "para mantener el metabolismo"
- Carbohidratos como base de la alimentación
- Luz artificial hasta medianoche
- Sedentarismo extremo con ejercicio forzado
...
- *Sistema glucosa:* Rápido pero limitado. Como un tanque pequeño que se agota rápido.
- *Sistema grasa:* Eficiente y prácticamente ilimitado. Como paneles solares que funcionan todo el día.

[Estudios científicos han demostrado](https://www.pnas.org/doi/10.1073/pnas.1418955112) que tu tolerancia a la glucosa es significativamente mejor por la mañana que por la noche. El problema es que comes tan frecuentemente que nunca le das tiempo al sistema de grasa para activarse.
...
- *Proteínas:* Carne, pescado, huevos, órganos - construcción y reparación celular
- *Grasas saturadas:* Mantequilla, sebo, aceite de coco - producción hormonal óptima  
- *Grasas monoinsaturadas:* Aceite de oliva, aguacate - inflamación controlada
- *Omega-3:* Pescados grasos, sardinas - función cerebral y recuperación
...
- *Cortisol alto en la mañana:* Para despertarte y activar tu metabolismo
- *Insulina sensible durante el día:* Para procesar nutrientes eficientemente  
- *Melatonina alta en la noche:* Para reparación y descanso profundo
...
[Un estudio de la Universidad de Alabama](https://doi.org/10.1016/j.cmet.2018.04.010) demostró que comer la misma comida a las 8 AM versus las 8 PM genera respuestas metabólicas completamente diferentes. La comida matutina se procesa más eficientemente y genera menos almacenamiento de grasa.

*Misma comida, diferente timing, resultados opuestos.*

Investigaciones en poblaciones que siguen patrones ancestrales son reveladoras: los [Inuit](https://pubmed.ncbi.nlm.nih.gov/4102857/) con dietas altas en grasa ([aunque con matices interesantes](https://pubmed.ncbi.nlm.nih.gov/25064579/)), los [Hadza](https://pubmed.ncbi.nlm.nih.gov/27723159/) con ayunos naturales, o los [Tsimane](https://pmc.ncbi.nlm.nih.gov/articles/PMC6028773/) con casi nula presencia de aterosclerosis coronaria, todos muestran ausencia de las enfermedades metabólicas modernas.
...
*Timing:* [Estudios clínicos recientes](https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2794819) demuestran que una ventana de alimentación temprana de 8 horas mejora significativamente los marcadores metabólicos. Si desayunas a las 8 AM, termina de comer a las 4 PM.
...
- ¿Tu energía se estabiliza durante el día?
- ¿Reduces la necesidad de snacks?
- ¿Mejora tu claridad mental por las mañanas?
