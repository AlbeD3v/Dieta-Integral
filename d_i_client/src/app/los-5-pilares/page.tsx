...
import { Sun, Leaf, Moon, TreePine, Zap } from 'lucide-react';
import { buildCanonicalMeta } from '@/utils/seo';
import type { Metadata } from 'next';

export const metadata: Metadata = buildCanonicalMeta({
  title: 'Los 5 pilares — Dieta Integral',
  description: 'Descubre los cinco pilares de Dieta Integral: ritmos circadianos, nutrición real, sueño reparador, entorno natural y movimiento funcional.',
  path: '/los-5-pilares',
});
...
export default function Los5PilaresPage() {
  return (
    <div>
      <main>
        {/* Hero */}
          ...
          <Container className="py-20 md:py-28 relative z-10">
            <FadeUp className="max-w-3xl mx-auto text-center space-y-5">
              ...
              <p className="text-lg md:text-xl text-[#475569] max-w-2xl mx-auto leading-relaxed">
                Un sistema integral construido sobre cinco fundamentos que trabajan juntos.
          ...
          <Container>
            <FadeUp className="max-w-2xl mx-auto text-center space-y-6">
              ...
              <p className="text-[#475569] leading-relaxed">
                Los cinco pilares no son reglas. Son el contexto que tu biología necesita para funcionar como fue diseñada.
